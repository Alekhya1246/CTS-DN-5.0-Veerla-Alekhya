...
insert into customers values ( 1,  'john',  21,  150000,  'FALSE' );
insert into customers values ( 2,'alice', 25,35000, 'FALSE' );
insert into customers values ( 3,'bob',22,25000,'FALSE');
insert into customers values ( 4,'robert',26,125000,'FALSE');
insert into customers values ( 5,'Alex',65,5000,'FALSE');
insert into customers values ( 6,'abraham',79,28000,'FALSE');
